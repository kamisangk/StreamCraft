...
class FlinkClientConfigTest {
    ...
    void flinkGatewayConfigExposesGatewayInterfaces() {
        contextRunner.run(context -> {
            ...
            assertThat(context).hasSingleBean(FlinkMetricsClient.class);
            assertThat(context).doesNotHaveBean("controllerRestTemplate");
            assertThat(context).doesNotHaveBean("controllerSubmissionRestTemplate");
        });
    }

    @EnableConfigurationProperties({
            FlinkGatewayProperties.class,
